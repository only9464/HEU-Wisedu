  ...
  <div class="main-container">
    ...
    <div class="settings-options">
      ...
      <div class="setting-option">
        <span class="option-label">官网：</span>
        <div class="option-control">
          <el-button 
            type="primary" 
            size="small" 
            color="#1e8fa3" 
            @click="openUrlLink('https://github.com/only9464/HEU-Wisedu')"
          >
            前往Github
          </el-button>
          <el-button 
            ...
            size="small" 
            color="#1e8fa3" 
            @click="openUrlLink('https://gitee.com/only9464/HEU-Wisedu')"
          >
            前往Gitee
          </el-button>
        </div>
          ...
          <div v-if="!globalStore.isLatestVersion">
            <span>(发现新版本：{{ globalStore.latestVersion }}
              <el-button 
                type="info" 
                size="small" 
                @click="openUrlLink('https://ghproxy.heu.us.kg/https://raw.githubusercontent.com/only9464/HEU-Wisedu/master/build/bin/HEU-Wisedu.exe')"
              >
                手动下载
              </el-button>
            )</span>
