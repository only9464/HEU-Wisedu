...
- [X] Windows[下载](https://gh-proxy.com/https://raw.githubusercontent.com/only9464/HEU-Wisedu/master/build/bin/HEU-Wisedu.exe)
- [X] MacOS  [下载](https://github.com/only9464/HEU-Wisedu/releases)
- [X] Linux  [下载](https://github.com/only9464/HEU-Wisedu/releases)

MacOS、Linux 懒得编译了，**暂时不能直接下载可执行程序**，有需要的可以自己下载源码编译，可以参考下面的**二次开发[打包](#3打包)** 部分
2025年11月26日14:22:27 新增跨平台编译，前往[https://github.com/only9464/HEU-Wisedu/releases](https://github.com/only9464/HEU-Wisedu/releases)下载最新版
